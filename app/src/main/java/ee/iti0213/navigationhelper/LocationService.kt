...
class LocationService : Service() {
    ...
    private fun showTrack() {
        ...
        intent.putExtra(C.TCK_UPD_TIME_START_KEY, formatTime(timeStart, true))
        intent.putExtra(C.TCK_UPD_SPEED_START_KEY, formatTime(speedStart, false) + getString(R.string.unit_speed))

        intent.putExtra(C.TCK_UPD_WALK_DIST_CP_KEY, "%.0f".format(walkDistCP) + getString(R.string.unit_dist))
        intent.putExtra(C.TCK_UPD_FLY_DIST_CP_KEY, "%.0f".format(flyDistCP) + getString(R.string.unit_dist))
        intent.putExtra(C.TCK_UPD_TIME_CP_KEY, formatTime(timeCP, true))
        intent.putExtra(C.TCK_UPD_SPEED_CP_KEY, formatTime(speedCP, false) + getString(R.string.unit_speed))

        intent.putExtra(C.TCK_UPD_WALK_DIST_WP_KEY, "%.0f".format(walkDistWP) + getString(R.string.unit_dist))
        intent.putExtra(C.TCK_UPD_FLY_DIST_WP_KEY, "%.0f".format(flyDistWP) + getString(R.string.unit_dist))
        intent.putExtra(C.TCK_UPD_TIME_WP_KEY, formatTime(timeWP, true))
        intent.putExtra(C.TCK_UPD_SPEED_WP_KEY, formatTime(speedWP, false) + getString(R.string.unit_speed))
    ...
    private fun showNotification() {
        ...
        notifyView.setTextViewText(R.id.walkDistStart, "%.0f".format(walkDistStart) + getString(R.string.unit_dist))
        notifyView.setTextViewText(R.id.flyDistStart, "%.0f".format(flyDistStart) + getString(R.string.unit_dist))
        notifyView.setTextViewText(R.id.timeStart, formatTime(timeStart, true))
        notifyView.setTextViewText(R.id.speedStart, formatTime(speedStart, false) + getString(R.string.unit_speed))

        notifyView.setTextViewText(R.id.walkDistCP, "%.0f".format(walkDistCP) + getString(R.string.unit_dist))
        notifyView.setTextViewText(R.id.flyDistCP, "%.0f".format(flyDistCP) + getString(R.string.unit_dist))
        notifyView.setTextViewText(R.id.timeCP, formatTime(timeCP, true))
        notifyView.setTextViewText(R.id.speedCP, formatTime(speedCP, false) + getString(R.string.unit_speed))

        notifyView.setTextViewText(R.id.walkDistWP, "%.0f".format(walkDistWP) + getString(R.string.unit_dist))
        notifyView.setTextViewText(R.id.flyDistWP, "%.0f".format(flyDistWP) + getString(R.string.unit_dist))
        notifyView.setTextViewText(R.id.timeWP, formatTime(timeWP, true))
        notifyView.setTextViewText(R.id.speedWP, formatTime(speedWP, false) + getString(R.string.unit_speed))
    ...
    private fun formatTime(time: Long, withSeconds: Boolean): String {
        val hours = time / 3600
